...
class IngredientsTest < ApplicationSystemTestCase
  ...
  test "should create ingredient" do
    ...
    fill_in "Purchase price", with: @ingredient.purchase_price
    fill_in "Purchase quantity", with: @ingredient.purchase_quantity
    fill_in "Purchase unit", with: @ingredient.purchase_unit
